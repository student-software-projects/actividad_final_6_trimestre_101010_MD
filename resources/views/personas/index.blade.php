...
@section('content')
    ...
    <div class="row" style="justify-content: center">
        <div class="card text-white p-4" style="width:600px; border:solid; opacity: 0.7; background: black;">
            <a class="btn btn-warning" style="width:200px" href="{{route('person.crear')}}">Agregar nuevo registro</a>
            @if(session('mensaje'))
            ...
            <div class="card-body">
                ...
                <table class="table table-hover">
                    ...
                    @foreach ($personas as $persona)
                        <tr>
                            <td>
                                <a class="btn btn-block text-white" href="{{route('person.detalle', $persona->id)}}">{{$persona->primer_nombre}} {{$persona->segundo_nombre}} {{$persona->apellidos}}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
