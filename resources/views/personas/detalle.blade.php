        ...
        <div class="card text-white p-4" style="width:700px; border:solid; opacity: 0.7; background: black;">
            <div class="card-body">
                ...
                <dl>
                    ...
                    <dt>opciones:</dt>
                    <dd class="pt-1">
                        <form action="{{route('person.eliminar', $persona->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
                            <a href="{{route('person.editar', $persona->id)}}" data-toggle="tooltip" data-placement="bottom" title="Editar" style="margin-right: 40px">
                ...
                <hr>
                <a class="btn btn-info" href="{{route('person.index')}}">Regresar</a>
            </div>
        </div>
    </div>
@endsection
