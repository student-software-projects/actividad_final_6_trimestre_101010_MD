...
@section('content')
    ...
    <div class="row" style="justify-content: center">
        <div class="card text-white p-4" style="width:600px; border:solid; opacity: 0.7; background: black;">
            <a class="btn btn-warning" style="width:200px" href="{{route('vehicle.crear')}}">Agregar nuevo registro</a>
            @if(session('mensaje'))
            ...
            <div class="card-body">
                ...
                <table class="table table-hover">
                    ...
                    @foreach ($vehiculos as $vehiculo)
                        <tr>
                            <td>
                                <a class="btn btn-block text-white" href="{{route('vehicle.detalle', $vehiculo->id)}}">{{$vehiculo->placa}}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
