            ...
            <div class="card-body">
                ...
                <form action="{{route('informes')}}" method="GET">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="buscar" name="buscar" placeholder="N° placa" value="{{$buscar}}">
                        </div>
                    </div>
                ...
                @elseif($buscar != '')
                    <p style="margin-top: 20px">dato consultado no registra en la Base de datos...</p>
                @endif
            </div>
        </div>
    </div>
